...
#inference_itr: calculate_local_score,
#build_training_obj: calculate_unary_potentials,calculate_pairwise_potentials
#check_convergence
#total: 9
...
class LearningTests(unittest.TestCase):
    ...
    def test_learning_obj(self):
        ...
        print("correct answer ",correct, "my answer ", result_val)
